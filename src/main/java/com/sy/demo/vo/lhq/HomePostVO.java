...
public class HomePostVO {
	...
	public String toString() {
		return "HomePostVO [postID=" + postID + ", title=" + title + ", userID=" + userID + ", userName=" + userName
				+ ", userImgPath=" + userImgPath + ", fmName=" + fmName + ", releaseTime=" + releaseTime
				+ ", replyUserID=" + replyUserID + ", replyUserName=" + replyUserName + ", replyUserTime="
				+ replyUserTime + "]";
	}
